      ...
      <body>
        <section class="vh-100 bg-white baskerville">
          <header class="tc ph5 lh-copy">
            <h1
              class="f1 f-headline-l code mb3 fw9 dib tracked-tight"
              style="color: dodgerblue"
            >
              Uh Oh
            </h1>
            <h2 class="tc f1-l fw1">
              The Dodgers are playing the ${game.opponent}
              <br />
              at ${game.gameTime} tonight.
            </h2>
            <div>
              <video
                style="width: 480px; height: 480px; left: 0px; top: 0px;"
                src="https://media2.giphy.com/media/AOMAKouVm1A2Y/giphy.mp4?cid=790b76115cd4951d6c36647436130e2a&amp;rid=giphy.mp4"
                poster="https://media2.giphy.com/media/AOMAKouVm1A2Y/giphy_s.gif?cid=790b76115cd4951d6c36647436130e2a&amp;rid=giphy_s.gif"
                autoplay
                loop
                muted
                playsinline
          ...
          <p class="tc">
            Sorry to say, but there's a game at Dodger Stadium on
              ${moment(game.date, 'YYYY-MM-DD').format('LL')} at
              ${game.gameTime}.
          </p>
        </section>
      </body>
  ...
  return html`
    ...
    <html lang="en" dir="ltr">
      ...
      <body>
        <section class="vh-100 bg-white baskerville">
          <header class="tc ph5 lh-copy">
            <h1 class="f1 f-headline-l code mb3 fw9 dib tracked-tight">
              Good News
            </h1>
            <h2 class="tc f1-l fw1">
            ...
            <div>
              <video
                ...
                src="https://media0.giphy.com/media/1guRIRFV5gN4ikrUakg/giphy.mp4?cid=790b76115cd4971a594b3271732fd348&amp;rid=giphy.mp4"
                poster="https://media0.giphy.com/media/1guRIRFV5gN4ikrUakg/giphy_s.gif?cid=790b76115cd4971a594b3271732fd348&amp;rid=giphy_s.gif"
                autoplay
                loop
                muted
                playsinline
